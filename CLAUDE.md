...
- **Production**: Migrations are applied automatically by CI on deploy (`wrangler d1 migrations apply --remote`) before the worker is deployed. This is defined in `.github/workflows/deploy.yml`.
